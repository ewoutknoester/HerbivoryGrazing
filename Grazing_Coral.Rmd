...
# TO DO: inspect in raw data/pics all the dead fragments (esp in reserves), because these seem to skew data and might likely be explained by hanging in the sand for some time (as all fragments are either completely healthy or dead)
